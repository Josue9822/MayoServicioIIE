...
public class ProductoController {
	...
	public ResponseEntity<ProductoDTOResponse> obtenerId(@PathVariable Integer id){
		ProductoDTOResponse p = service.obtenerProducto(id);
		 if (p != null) {
			 ...
			 return new ResponseEntity<ProductoDTOResponse>(service.obtenerProducto(id), HttpStatus.OK);
	...
	public ResponseEntity<Void> guardar(@RequestBody ProductoDTOResponse productos){
	...
	public ResponseEntity<Void> actualizar(@RequestBody ProductoDTOResponse productos){
		ProductoDTOResponse p = service.obtenerProducto(productos.getIdProducto());
